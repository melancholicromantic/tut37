...
public:
    ...
    bool Init()
    {
        ...
        if (!m_quad.LoadMesh("C:/GE/Projects/Content-main/quad.obj")) {
            return false;
        }

        if (!m_box.LoadMesh("C:/GE/Projects/Content-main/box.obj")) {
			return false;
		}

        if (!m_bsphere.LoadMesh("C:/GE/Projects/Content-main/sphere.obj")) {
			return false;
		}
